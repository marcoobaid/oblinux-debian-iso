...
This directory contains the approved foundational OBLinux identity, its source
material, licensing, and usage rules.
...
- `LICENSE-CC-BY-SA-4.0.txt`: branding-asset license

The generated wordmarks contain outlined paths and have no runtime font
